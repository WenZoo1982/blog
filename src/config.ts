...
export const siteConfig: SiteConfig = {
	title: "WenZoo Blog",
	subtitle: "探索开源技术，分享 AI 工具、系统配置与网络安全实践经验。",
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		//{
		//	name: "GitHub",
		//	url: "https://github.com/WenZoo1982", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
	...
	name: "WenZoo",
	bio: "探索开源技术，分享 AI 工具、系统配置与网络安全实践经验。",
	links: [
		{
			name: "QQ",
